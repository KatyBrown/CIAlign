...
![Remove Divergent](man/images/remove_divergent.png?raw=true)
...
![Remove Insertions](man/images/remove_insertions.png?raw=true)
...
![Crop Ends](man/images/crop_ends.png?raw=true)
...
### Mini Alignments
These functions produce "mini alignments" - man/images showing a small representation of your whole alignment, so that gaps and poorly aligned regions are clearly visible.
...
![CBS palette](man/images/palettes_CBS.png?raw=true)
![Bright palette](man/images/palettes_bright.png?raw=true)
...
![Sequence logo text](man/images/sequence_logo.png?raw=true)
![Sequence logo bar](man/images/sequence_logo_bar.png?raw=true)
